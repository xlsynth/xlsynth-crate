...
multiply, and product-pair forms, serializes it, parses and re-emits it through libxls,
...
interoperability boundary and structural stability of the PIR roundtrip.
...
surface using constrained-signature generation and asserts that their complete
function signatures match. Failures expose bugs in the paired-function
generator used by graph-comparison targets.
