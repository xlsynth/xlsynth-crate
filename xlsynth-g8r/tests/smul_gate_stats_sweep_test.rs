...
fn test_smul_widening_qor_and_equivalence_sweep() {
    ...
    let want: &[SmulWideningRow] = &[
        ...
        SmulWideningRow { operand_width: 2, output_width: 4, sign_extend_live_nodes: 32, sign_extend_deepest_path: 9, native_signed_live_nodes: 19, native_signed_deepest_path: 6 },
        SmulWideningRow { operand_width: 3, output_width: 4, sign_extend_live_nodes: 48, sign_extend_deepest_path: 11, native_signed_live_nodes: 42, native_signed_deepest_path: 9 },
        SmulWideningRow { operand_width: 3, output_width: 5, sign_extend_live_nodes: 78, sign_extend_deepest_path: 15, native_signed_live_nodes: 54, native_signed_deepest_path: 10 },
        SmulWideningRow { operand_width: 3, output_width: 6, sign_extend_live_nodes: 114, sign_extend_deepest_path: 17, native_signed_live_nodes: 61, native_signed_deepest_path: 12 },
        SmulWideningRow { operand_width: 4, output_width: 5, sign_extend_live_nodes: 87, sign_extend_deepest_path: 15, native_signed_live_nodes: 81, native_signed_deepest_path: 13 },
        SmulWideningRow { operand_width: 4, output_width: 6, sign_extend_live_nodes: 129, sign_extend_deepest_path: 17, native_signed_live_nodes: 105, native_signed_deepest_path: 14 },
        SmulWideningRow { operand_width: 4, output_width: 8, sign_extend_live_nodes: 226, sign_extend_deepest_path: 21, native_signed_live_nodes: 131, native_signed_deepest_path: 18 },
        SmulWideningRow { operand_width: 5, output_width: 6, sign_extend_live_nodes: 138, sign_extend_deepest_path: 17, native_signed_live_nodes: 132, native_signed_deepest_path: 16 },
        SmulWideningRow { operand_width: 5, output_width: 8, sign_extend_live_nodes: 258, sign_extend_deepest_path: 21, native_signed_live_nodes: 201, native_signed_deepest_path: 20 },
        SmulWideningRow { operand_width: 5, output_width: 10, sign_extend_live_nodes: 400, sign_extend_deepest_path: 27, native_signed_live_nodes: 227, native_signed_deepest_path: 24 },
        SmulWideningRow { operand_width: 8, output_width: 10, sign_extend_live_nodes: 473, sign_extend_deepest_path: 27, native_signed_live_nodes: 439, native_signed_deepest_path: 25 },
        SmulWideningRow { operand_width: 8, output_width: 12, sign_extend_live_nodes: 671, sign_extend_deepest_path: 31, native_signed_live_nodes: 561, native_signed_deepest_path: 29 },
        SmulWideningRow { operand_width: 8, output_width: 14, sign_extend_live_nodes: 906, sign_extend_deepest_path: 35, native_signed_live_nodes: 639, native_signed_deepest_path: 33 },
        SmulWideningRow { operand_width: 8, output_width: 16, sign_extend_live_nodes: 1104, sign_extend_deepest_path: 39, native_signed_live_nodes: 673, native_signed_deepest_path: 37 },
        SmulWideningRow { operand_width: 12, output_width: 18, sign_extend_live_nodes: 1614, sign_extend_deepest_path: 43, native_signed_live_nodes: 1365, native_signed_deepest_path: 43 },
        SmulWideningRow { operand_width: 12, output_width: 24, sign_extend_live_nodes: 2514, sign_extend_deepest_path: 55, native_signed_live_nodes: 1623, native_signed_deepest_path: 55 },
    ];
