...
fn test_prio_encode_gate_stats_sweep_1_to_16() {
    ...
    let want: &[PrioEncodeRow] = &[
        ...
        PrioEncodeRow { bit_count: 5, prio: "lsb", live_nodes: 18, deepest_path: 7 },
        ...
        PrioEncodeRow { bit_count: 9, prio: "lsb", live_nodes: 36, deepest_path: 9 },
        PrioEncodeRow { bit_count: 9, prio: "msb", live_nodes: 29, deepest_path: 7 },
        PrioEncodeRow { bit_count: 10, prio: "lsb", live_nodes: 39, deepest_path: 9 },
        ...
        PrioEncodeRow { bit_count: 13, prio: "lsb", live_nodes: 52, deepest_path: 9 },
