...
fn test_cmp_gate_stats_sweep_8b_all_rhs_specs() {
    ...
    let want: &[CmpRow] = &[
        ...
        // ult
        CmpRow { cmp: "ult", rhs: "param", live_nodes: 56, deepest_path: 9 },
        ...
        // ugt
        CmpRow { cmp: "ugt", rhs: "param", live_nodes: 56, deepest_path: 9 },
        ...
        CmpRow { cmp: "slt", rhs: "pow2_4", live_nodes: 8, deepest_path: 4 },
        CmpRow { cmp: "slt", rhs: "pow2_5", live_nodes: 6, deepest_path: 4 },
        ...
        CmpRow { cmp: "sle", rhs: "pow2_4", live_nodes: 16, deepest_path: 6 },
        CmpRow { cmp: "sle", rhs: "pow2_5", live_nodes: 18, deepest_path: 6 },
        CmpRow { cmp: "sle", rhs: "pow2_6", live_nodes: 18, deepest_path: 6 },
        CmpRow { cmp: "sle", rhs: "pow2_7", live_nodes: 15, deepest_path: 4 },
        CmpRow { cmp: "sle", rhs: "pow2m1_1", live_nodes: 14, deepest_path: 5 },
        CmpRow { cmp: "sle", rhs: "pow2m1_2", live_nodes: 12, deepest_path: 5 },
        CmpRow { cmp: "sle", rhs: "pow2m1_3", live_nodes: 10, deepest_path: 5 },
        CmpRow { cmp: "sle", rhs: "pow2m1_4", live_nodes: 8, deepest_path: 4 },
        CmpRow { cmp: "sle", rhs: "pow2m1_5", live_nodes: 6, deepest_path: 4 },
        CmpRow { cmp: "sle", rhs: "pow2m1_6", live_nodes: 4, deepest_path: 3 },
