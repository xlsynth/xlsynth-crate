...
fn test_ext_clz_gate_stats_sweep_1_to_16() {
    ...
    let want: &[ClzRow] = &[
        ...
        ClzRow { bit_count: 5, live_nodes: 23, deepest_path: 9 },
        ...
        ClzRow { bit_count: 9, live_nodes: 42, deepest_path: 11 },
        ClzRow { bit_count: 10, live_nodes: 45, deepest_path: 10 },
        ClzRow { bit_count: 11, live_nodes: 52, deepest_path: 11 },
        ClzRow { bit_count: 12, live_nodes: 53, deepest_path: 10 },
        ClzRow { bit_count: 13, live_nodes: 59, deepest_path: 11 },
