...
use crate::ir2gates::{self, DEFAULT_ENABLE_FORMAL_ARRAY_READ_REWRITE};
...
fn default_enable_formal_array_read_rewrite() -> bool {
    DEFAULT_ENABLE_FORMAL_ARRAY_READ_REWRITE
}
...
pub struct CanonicalG8rOptions {
    ...
    #[serde(default = "default_enable_formal_array_read_rewrite")]
    pub enable_formal_array_read_rewrite: bool,
    pub adder_mapping: crate::ir2gate_utils::AdderMapping,
    pub mul_adder_mapping: Option<crate::ir2gate_utils::AdderMapping>,
    pub unsafe_gatify_gate_operation: bool,
...
impl CanonicalG8rOptions {
    ...
    pub fn to_process_ir_path_options(
        ...
        Options {
            ...
            enable_formal_array_read_rewrite: self.enable_formal_array_read_rewrite,
...
impl From<&Options> for ir2gates::Ir2GatesOptions {
    fn from(options: &Options) -> Self {
        Self {
            ...
            enable_formal_array_read_rewrite: options.enable_formal_array_read_rewrite,
...
mod tests {
    ...
    #[test]
    fn canonical_options_default_to_formal_array_rewrite() {
        let canonical = CanonicalG8rOptions::default();
        assert!(canonical.enable_formal_array_read_rewrite);
    }

    #[test]
    fn missing_serialized_formal_array_rewrite_uses_canonical_default() {
        let mut value = serde_json::to_value(CanonicalG8rOptions::default()).unwrap();
        value
            .as_object_mut()
            .unwrap()
            .remove("enable_formal_array_read_rewrite");
