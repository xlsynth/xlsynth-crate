...
test_with_solver!(
    ...
    &crate::equiv::bitwuzla_backend::BitwuzlaConfig {
        term_manager: crate::equiv::bitwuzla_backend::BitwuzlaTermManager::new(),
        options: crate::equiv::bitwuzla_backend::BitwuzlaOptions::new(),
    }
);
