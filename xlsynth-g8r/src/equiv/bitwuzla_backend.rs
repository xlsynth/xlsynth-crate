...
use bitwuzla_sys::{
    ...
    bitwuzla_term_to_string, bitwuzla_term_value_get_str, BitwuzlaKind, BITWUZLA_KIND_BV_ADD,
    BITWUZLA_KIND_BV_AND, BITWUZLA_KIND_BV_ASHR, BITWUZLA_KIND_BV_CONCAT, BITWUZLA_KIND_BV_EXTRACT,
    BITWUZLA_KIND_BV_MUL, BITWUZLA_KIND_BV_NAND, BITWUZLA_KIND_BV_NEG, BITWUZLA_KIND_BV_NOR,
    BITWUZLA_KIND_BV_NOT, BITWUZLA_KIND_BV_OR, BITWUZLA_KIND_BV_SDIV, BITWUZLA_KIND_BV_SGE,
    BITWUZLA_KIND_BV_SGT, BITWUZLA_KIND_BV_SHL, BITWUZLA_KIND_BV_SHR, BITWUZLA_KIND_BV_SIGN_EXTEND,
    BITWUZLA_KIND_BV_SLE, BITWUZLA_KIND_BV_SLT, BITWUZLA_KIND_BV_SREM, BITWUZLA_KIND_BV_SUB,
    BITWUZLA_KIND_BV_UDIV, BITWUZLA_KIND_BV_UGE, BITWUZLA_KIND_BV_UGT, BITWUZLA_KIND_BV_ULE,
    BITWUZLA_KIND_BV_ULT, BITWUZLA_KIND_BV_UREM, BITWUZLA_KIND_BV_XOR,
    BITWUZLA_KIND_BV_ZERO_EXTEND, BITWUZLA_KIND_EQUAL, BITWUZLA_KIND_ITE, BITWUZLA_KIND_NOT,
    BITWUZLA_OPT_ABSTRACTION, BITWUZLA_OPT_ABSTRACTION_ASSERT,
    ...
    BITWUZLA_OPT_WRITE_CNF, BITWUZLA_SAT, BITWUZLA_UNKNOWN, BITWUZLA_UNSAT,
};
...
struct RawBitwuzlaTermManager {
    raw: *mut bitwuzla_sys::BitwuzlaTermManager,
}

impl RawBitwuzlaTermManager {
    pub fn new() -> Self {
        let raw = unsafe { bitwuzla_term_manager_new() };
        RawBitwuzlaTermManager { raw }
    }
}

impl Drop for RawBitwuzlaTermManager {
    fn drop(&mut self) {
        unsafe { bitwuzla_term_manager_release(self.raw) };
    }
}

#[derive(Clone)]
pub struct BitwuzlaTermManager {
    term_manager: Arc<RawBitwuzlaTermManager>,
}

impl BitwuzlaTermManager {
    pub fn new() -> Self {
        BitwuzlaTermManager {
            term_manager: Arc::new(RawBitwuzlaTermManager::new()),
        }
    }
}
...
struct RawBitwuzla {
    ...
    term_manager: BitwuzlaTermManager,
}

impl RawBitwuzla {
    pub fn new(
        term_manager: BitwuzlaTermManager,
        options: *const bitwuzla_sys::BitwuzlaOptions,
    ) -> Self {
        let raw = unsafe { bitwuzla_new(term_manager.term_manager.raw, options) };
...
impl Drop for RawBitwuzla {
    fn drop(&mut self) {
        unsafe { bitwuzla_delete(self.raw) };
    }
}
...
impl Bitwuzla {
    pub fn raw_term_manager(&self) -> *mut bitwuzla_sys::BitwuzlaTermManager {
        self.bitwuzla.term_manager.term_manager.raw
    }
...
pub struct BitwuzlaConfig {
    pub term_manager: BitwuzlaTermManager,
    pub options: BitwuzlaOptions,
}

unsafe impl Send for BitwuzlaConfig {}
unsafe impl Sync for BitwuzlaConfig {}
...
impl Solver for Bitwuzla {
    ...
    type Config = BitwuzlaConfig;

    fn new(config: &BitwuzlaConfig) -> io::Result<Self> {
        let instance = RawBitwuzla::new(config.term_manager.clone(), config.options.options.raw);
        Ok(Bitwuzla {
...
test_solver!(
    bitwuzla_tests,
    super::Bitwuzla::new(&super::BitwuzlaConfig {
        term_manager: super::BitwuzlaTermManager::new(),
        options: super::BitwuzlaOptions::new(),
    })
    .unwrap()
);
