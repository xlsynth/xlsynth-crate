...
pub mod frobber {
    ...
    unsafe extern "C" {
        #[link_name = "__frobber__frob_widget"]
        fn __xlsynth_aot_linked_symbol_duplicate_widget();
    }

    const ENTRYPOINTS_PROTO: &[u8] = include_bytes!("duplicate_widget.entrypoints.pb");
    ...
    #[allow(clippy::deref_addrof, clippy::explicit_auto_deref, clippy::identity_op)]
    fn decode_output_0(src: &[u8]) -> Result<super::bar::widget::Widget, xlsynth::XlsynthError> {
    ...
    pub fn descriptor() -> xlsynth::AotEntrypointDescriptor<'static> {
        unsafe {
            xlsynth::AotEntrypointDescriptor::from_raw_parts_unchecked(
                ENTRYPOINTS_PROTO,
                __xlsynth_aot_linked_symbol_duplicate_widget as *const () as usize,
                xlsynth::AotEntrypointMetadata {
                    symbol: "__frobber__frob_widget".to_string(),
    ...
    impl Runner {
        ...
        ) -> Result<xlsynth::AotRunResult<super::bar::widget::Widget>, xlsynth::XlsynthError>
        {
        ...
        pub fn run(
            &mut self,
            widget: &super::foo::widget::Widget,
        ) -> Result<super::bar::widget::Widget, xlsynth::XlsynthError> {
            encode_input_0(widget, self.inner.input_mut(0))?;
            self.inner.run()?;
