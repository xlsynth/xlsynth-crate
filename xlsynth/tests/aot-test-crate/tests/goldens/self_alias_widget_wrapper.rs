...
// Generated by xlsynth::aot_builder from DSLX build spec "self_alias_widget".
...
pub mod self_alias_widget {
    ...
    unsafe extern "C" {
        #[link_name = "__xlsynth_standalone_self_alias_widget"]
        fn __xlsynth_aot_linked_symbol_self_alias_widget();
    }
    ...
    pub const ARTIFACT_METADATA: AotArtifactMetadata = AotArtifactMetadata {
        abi_version: 1,
        entrypoint_symbol: "__xlsynth_standalone_self_alias_widget",
        has_asserts: false,
        has_traces: false,
    };
    ...
    fn encode_input_0(_value: &WidgetHandle, dst: &mut [u8]) -> Result<(), AotError> {
    ...
    #[allow(clippy::deref_addrof, clippy::explicit_auto_deref, clippy::identity_op)]
    fn decode_output_0(src: &[u8]) -> Result<WidgetHandle, AotError> {
        ...
        let decoded_value_2 = WidgetHandle {
    ...
    impl Runner {
            ...
            Ok(Self {
                inner: unsafe {
                    StandaloneRunner::new(
                        &ARTIFACT_METADATA,
                        __xlsynth_aot_linked_symbol_self_alias_widget as *const (),
                        &RUNNER_LAYOUT,
                    )?
                },
            })
        ...
        pub fn run_with_events(
            &mut self,
            widget: &WidgetHandle,
        ) -> Result<AotRunResult<WidgetHandle>, AotError> {
        ...
        pub fn run(&mut self, widget: &WidgetHandle) -> Result<WidgetHandle, AotError> {
            encode_input_0(widget, self.inner.input_mut(0))?;
            self.inner.run_raw();
