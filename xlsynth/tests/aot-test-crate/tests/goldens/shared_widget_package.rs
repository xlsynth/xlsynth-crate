...
// Generated by xlsynth::aot_builder from typed DSLX AOT package "shared_widget_package".
...
use super::*;
unsafe extern "C" {
#[link_name = "__xlsynth_standalone_bump_widget"]
...
abi_version: 1,
entrypoint_symbol: "__xlsynth_standalone_bump_widget",
has_asserts: false,
has_traces: false,
};
...
fn encode_input_0(_value: &super::super::shared_widget_types::Widget, dst: &mut [u8]) -> Result<(), AotError> {
...
#[allow(clippy::deref_addrof, clippy::explicit_auto_deref, clippy::identity_op)]
fn decode_output_0(src: &[u8]) -> Result<super::super::shared_widget_types::Widget, AotError> {
...
&ARTIFACT_METADATA,
__xlsynth_aot_linked_symbol_bump_widget as *const (),
&RUNNER_LAYOUT,
)? },
})
}
...
/// fails.
pub fn run_with_events(&mut self, widget: &super::super::shared_widget_types::Widget) -> Result<AotRunResult<super::super::shared_widget_types::Widget>, AotError> {
...
pub fn run(&mut self, widget: &super::super::shared_widget_types::Widget) -> Result<super::super::shared_widget_types::Widget, AotError> {
        encode_input_0(widget, self.inner.input_mut(0))?;
self.inner.run_raw();
...
use super::*;
unsafe extern "C" {
#[link_name = "__xlsynth_standalone_echo_widget"]
...
pub const ARTIFACT_METADATA: AotArtifactMetadata = AotArtifactMetadata {
abi_version: 1,
entrypoint_symbol: "__xlsynth_standalone_echo_widget",
has_asserts: false,
has_traces: false,
};
...
inner: unsafe { StandaloneRunner::new(
&ARTIFACT_METADATA,
__xlsynth_aot_linked_symbol_echo_widget as *const (),
&RUNNER_LAYOUT,
)? },
})
}
