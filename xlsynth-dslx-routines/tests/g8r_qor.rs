...
fn add_variants_g8r_qor_snapshot() {
    ...
    let want: &[QorRow] = &[
        ...
        QorRow { width: 8, variant: "carry_select_default", live_nodes: 124, deepest_path: 14 },
        QorRow { width: 8, variant: "carry_select_with_carry_default", live_nodes: 183, deepest_path: 15 },
        QorRow { width: 8, variant: "carry_select_tuned", live_nodes: 124, deepest_path: 11 },
        QorRow { width: 8, variant: "carry_select_with_carry_tuned", live_nodes: 157, deepest_path: 13 },
        ...
        QorRow { width: 16, variant: "carry_select_default", live_nodes: 306, deepest_path: 17 },
        QorRow { width: 16, variant: "carry_select_with_carry_default", live_nodes: 365, deepest_path: 19 },
        QorRow { width: 16, variant: "carry_select_tuned", live_nodes: 306, deepest_path: 17 },
        QorRow { width: 16, variant: "carry_select_with_carry_tuned", live_nodes: 365, deepest_path: 19 },
        ...
        QorRow { width: 32, variant: "carry_select_default", live_nodes: 670, deepest_path: 25 },
        QorRow { width: 32, variant: "carry_select_with_carry_default", live_nodes: 729, deepest_path: 27 },
        QorRow { width: 32, variant: "carry_select_tuned", live_nodes: 670, deepest_path: 29 },
        QorRow { width: 32, variant: "carry_select_with_carry_tuned", live_nodes: 781, deepest_path: 31 },
    ];
    assert_eq!(got.as_slice(), want);
}
...
fn mul_variants_g8r_qor_snapshot() {
    ...
    let want: &[QorRow] = &[
        ...
        QorRow { width: 8, variant: "shift_add_prefix", live_nodes: 284, deepest_path: 39 },
        QorRow { width: 8, variant: "shift_add_carry_select_default", live_nodes: 366, deepest_path: 36 },
        QorRow { width: 8, variant: "shift_add_carry_select_tuned", live_nodes: 350, deepest_path: 37 },
        ...
        QorRow { width: 16, variant: "shift_add_carry_select_default", live_nodes: 2035, deepest_path: 97 },
        QorRow { width: 16, variant: "shift_add_carry_select_tuned", live_nodes: 2035, deepest_path: 97 },
        ...
        QorRow { width: 32, variant: "shift_add_carry_select_default", live_nodes: 9550, deepest_path: 225 },
        QorRow { width: 32, variant: "shift_add_carry_select_tuned", live_nodes: 9595, deepest_path: 227 },
    ];
    assert_eq!(got.as_slice(), want);
}
